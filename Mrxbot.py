...
wib = pytz.timezone('Africa/Algiers')
...
class Boinkers:
    ...
    def welcome(self):
        print(
            f"""
        {Fore.GREEN + Style.BRIGHT}Boinkers Script by {Fore.BLUE + Style.BRIGHT}BS • MRx
            """
            f"""
        {Fore.GREEN + Style.BRIGHT}Join Script Channel:- {Fore.YELLOW + Style.BRIGHT}https://t.me/BS • MRx
            """
        )
